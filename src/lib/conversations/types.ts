...
export type ConversationContact={id:string;name:string;email:string;permissionScope:"none"|"free_busy"|"categories";incomingPermissionScope:"none"|"free_busy"|"categories"};
